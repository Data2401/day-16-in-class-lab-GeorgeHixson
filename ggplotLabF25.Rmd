...
```{r}
heights %>% group_by(sex) %>%  summarize(mean_height = mean(height, na.rm = T), median_height = median(height, na.rm = T))

heights %>% summarize(mean_height = mean(height, na.rm = T), median_height = median(height, na.rm = T), .by = sex)
...
```{R}
heights %>% group_by(sex) %>%  summarize(max_height = max(height, na.rm = T), min_height = min(height, na.rm = T))
